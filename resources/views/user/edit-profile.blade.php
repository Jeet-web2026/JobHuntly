                    ...
                    <form method="POST" action="{{ route('user.user-details-save') }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form-control shadow-none text-b" id="full-name" name="full-name" value="{{ old('full-name') }}">
                                @error('full-name')
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select class="form-select shadow-none text-b" id="last-qualification" name="last-qualification">
                                    ...
                                    <option value="Graduate" @selected(old('last-qualification') === 'Graduate')>Graduate</option>
                                    <option value="Post graduate" @selected(old('last-qualification') === 'Post graduate')>Post graduate</option>
                                    <option value="Diploma" @selected(old('last-qualification') === 'Diploma')>Diploma</option>
                                    <option value="12th Pass" @selected(old('last-qualification') === '12th Pass')>12th Pass</option>
                                    <option value="10th Pass" @selected(old('last-qualification') === '10th Pass')>10th Pass</option>
                                </select>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="email" class="form-control shadow-none text-b" id="email-address" name="email-address" value="{{ old('email-address') }}">
                                @error('email-address')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="tel" class="form-control shadow-none text-b" id="tel-number" name="tel-number" value="{{ old('tel-number') }}">
                                @error('tel-number')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" class="form-control shadow-none text-b" id="city" name="city" value="{{ old('city') }}">
                                @error('city')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="date" class="form-control shadow-none text-b" id="dob" name="dob" value="{{ old('dob') }}">
                                @error('dob')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
